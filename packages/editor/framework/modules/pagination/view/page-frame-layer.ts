...
/**
 * 滚动容器内的「A4 纸张背景层」：一个绝对定位、pointer-events:none 的 div，
 * 作为滚动容器的首个子节点（绘制在内容之下），内含若干 .bc-page-sheet。
...
export class PageFrameLayer {
  ...
  mount(): void {
    ...
    this.scrollContainer.insertBefore(el, this.scrollContainer.firstChild);
    this._root = el;
  }
