// Clipboard-owned Youdao Note HTML fallback.
//
...
//
// Lives in the Clipboard domain: ClipboardManager short-circuits here when
// isYoudaoHtml() matches, before delegating ordinary HTML to the core HtmlAdapter.
...
import { DocFileService, IBlockSnapshot, generateId } from "../../../..";
