...
import {ClipboardManager} from '../modules/clipboard/clipboard-manager';
import {InputTransformer} from '../modules/input';
import {SelectionManager} from '../modules/selection';
import {ClipboardCopyFilter} from '../modules/clipboard/types';
import {RootVirtualizationManager} from '../modules/virtualization/root-virtualization-manager';
import {VirtualizationConfig} from '../modules/virtualization/types';
import { BehaviorSubject, Subject, Subscription, take } from "rxjs";
import { getCommonPath } from "../utils";
import { DocPlugin } from "../plugin";
import {DOC_MESSAGE_SERVICE_TOKEN} from '../angular/host-service-tokens';
import {DocOverlayService} from '../angular/overlay.service';
import { DocDndService } from "../modules/drag-drop/dnd.service";
import { DocInternalDragController } from "../modules/drag-drop/internal-drag.controller";
...
} from '../modules/object/block-placement.manager'
import {BlockObjectSizingManager} from '../modules/object/block-object-sizing.manager'
import {BlockObjectFormatManager} from '../modules/object/block-object-format.manager'
import {DocumentViewScaleManager} from './view/document-view-scale.manager'
import {
  DocumentLayoutMetricsConfig,
  DocumentLayoutMetricsManager,
} from './view/document-layout-metrics.manager'
import {
  BlockMutationPolicy,
...
export class BlockCraftDoc {
  ...
  readonly clipboard = this.runtime.createClipboard(this)
  ...
  constructor(
    ...
    this.config.embeds = this.runtime.resolveEmbeds(this.config.embeds)
