import {downloadFile} from '@ccc/blockcraft/global/utils';
import type {DocFilePort, DocAttachmentInfo, UploadProgressCallback} from '@ccc/blockcraft/framework/ports';
export type {DocFilePort, DocAttachmentInfo, UploadProgressCallback} from '@ccc/blockcraft/framework/ports';
export {DOC_FILE_SERVICE_TOKEN} from '../angular/host-service-tokens';

export abstract class DocFileService implements DocFilePort {
