...
//
// 来源识别由 clipboard-source-adapter.ts 接入剪贴板，优先于通用 HTML codec。
// 转换阶段只生成快照；附件标记在插入前剥离，重传由剪贴板安排到下一 tick。
...
export function parseYoudaoHtml(html: string, fileService: DocFilePort): IBlockSnapshot | null {
