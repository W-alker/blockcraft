...
import type {DocLinkPreviewPort, LinkPreviewData} from '@ccc/blockcraft/framework/ports';
...
export class DocLinkPreviewerService implements DocLinkPreviewPort {
  private _endpoint = 'https://affine-worker.toeverything.workers.dev/api/worker/link-preview';
