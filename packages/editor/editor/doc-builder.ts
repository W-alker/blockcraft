...
import { EmbedConverter, IBlockSnapshot, YBlock } from "../framework/block-std"
import {BlockCraftDoc} from "./document"
import type {BlockLockKind, BlockUnlockContext} from "../framework/doc/block-readonly.types"
import { DocPlugin } from "../framework/plugin"
...
export class BlockCraftDocBuilder {
  ...
  clone() {
    ...
    cloned.config.defaultBlockLockKind = this.config.defaultBlockLockKind
  ...
  defaultBlockLockKind(kind: BlockLockKind) {
    this.config.defaultBlockLockKind = kind
    return this
  }
  ...
  build() {
    ...
    return new BlockCraftDoc({
      ...
      defaultBlockLockKind: this.config.defaultBlockLockKind,
