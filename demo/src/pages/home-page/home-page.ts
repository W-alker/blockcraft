...
import {ContextmenuCreator, IContextMenuItem} from "../../components/contextmenu";
...
@Component({
  ...
  standalone: true,
  imports: [NzInputModule, FormsModule, NgForOf, DatePipe, MatIconModule, NzTableModule, NgIf]
})
export class HomePage {
  ...
  onItemClick(event: MouseEvent, item: DataItem) {
